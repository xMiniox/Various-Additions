	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				VariousAdditionsMod.LOGGER.warn("Failed to load dependency entity for procedure CurseOfTheMistKill!");
			return;
		}
		...
		if (((new Object() {
			...
			entity.attackEntityFrom(DamageSource.WITHER, (float) 1000);
		}
	}
