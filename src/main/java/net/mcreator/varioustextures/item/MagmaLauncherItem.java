...
public class MagmaLauncherItem extends VariousAdditionsModElements.ModElement {
	@ObjectHolder("various_additions:magma_launcher")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletmagma_launcher").setRegistryName("entitybulletmagma_launcher"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(MagniumItemGroup.tab).maxDamage(100));
			setRegistryName("magma_launcher");
		}
