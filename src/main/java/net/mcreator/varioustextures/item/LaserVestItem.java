...
public class LaserVestItem extends VariousAdditionsModElements.ModElement {
	@ObjectHolder("various_additions:laser_vest_helmet")
	public static final Item helmet = null;
	@ObjectHolder("various_additions:laser_vest_chestplate")
	public static final Item body = null;
	@ObjectHolder("various_additions:laser_vest_leggings")
	public static final Item legs = null;
	@ObjectHolder("various_additions:laser_vest_boots")
	public static final Item boots = null;
	public LaserVestItem(VariousAdditionsModElements instance) {
		super(instance, 133);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{0, 0, 6, 0}[slot.getIndex()];
			}
		...
		}.setRegistryName("laser_vest_chestplate"));
	}
