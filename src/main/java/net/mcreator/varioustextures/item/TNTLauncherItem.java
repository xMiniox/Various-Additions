...
public class TNTLauncherItem extends VariousAdditionsModElements.ModElement {
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(MagniumItemGroup.tab).maxStackSize(1));
			setRegistryName("tnt_launcher");
		}
			...
			if (this.inGround) {
				{
					...
					TNTLauncherBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
