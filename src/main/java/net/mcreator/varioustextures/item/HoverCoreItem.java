...
public class HoverCoreItem extends VariousAdditionsModElements.ModElement {
	@ObjectHolder("various_additions:hover_core")
	public static final Item block = null;
	public HoverCoreItem(VariousAdditionsModElements instance) {
		super(instance, 62);
	}
