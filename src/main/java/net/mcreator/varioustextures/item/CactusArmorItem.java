...
public class CactusArmorItem extends VariousAdditionsModElements.ModElement {
	@ObjectHolder("various_additions:cactus_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("various_additions:cactus_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("various_additions:cactus_armor_leggings")
