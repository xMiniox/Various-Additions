...
import net.mcreator.varioustextures.procedures.DragonsFuryOverlayDisplayProcedure;
...
public class DragonsFuryOverlayOverlay extends VariousAdditionsModElements.ModElement {
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (DragonsFuryOverlayDisplayProcedure.executeProcedure(ImmutableMap.of("entity", entity))) {
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("various_additions:textures/dragons_fury_overlay.png"));
