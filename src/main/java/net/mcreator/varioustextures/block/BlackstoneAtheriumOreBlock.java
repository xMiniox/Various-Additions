...
public class BlackstoneAtheriumOreBlock extends VariousAdditionsModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("various_additions:blackstone_atherium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("blackstone_atherium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("various_additions:blackstone_atherium_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
