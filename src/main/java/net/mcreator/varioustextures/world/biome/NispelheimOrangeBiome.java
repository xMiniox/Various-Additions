...
public class NispelheimOrangeBiome extends VariousAdditionsModElements.ModElement {
	public static Biome biome;
	public NispelheimOrangeBiome(VariousAdditionsModElements instance) {
		super(instance, 318);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("various_additions:nispelheim_orange"));
			}
		}
	}
	@Override
