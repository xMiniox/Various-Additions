...
public class NispelheimRedBiome extends VariousAdditionsModElements.ModElement {
	public static Biome biome;
	public NispelheimRedBiome(VariousAdditionsModElements instance) {
		super(instance, 336);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-11796480).setWaterColor(-12303292).setWaterFogColor(-12303292)
						.withSkyColor(-11796480).withFoliageColor(-12303292).withGrassColor(-12303292)
						.setMoodSound(
						...
						.setParticle(new ParticleEffectAmbience(ParticleTypes.DRIPPING_LAVA, 0.005f)).build();
				...
				event.getRegistry().register(biome.setRegistryName("various_additions:nispelheim_red"));
			}
		}
	}
	@Override
